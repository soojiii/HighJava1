...
//		}
//		
//		th1.stop();  //비추천이라 취소선생김
////		th1.setStop(true);
//	}

		// interrupt()메서드를 이용한 쓰레드 멈추기
		TheradStopTest02 th2 = new TheradStopTest02();
		th2.start();
...
class TheradStopTest02 extends Thread {
	@Override
	public void run() {
...
//		}
		...
		while (true) {
			...
			//	     이용한다. ==> isInterrupred()메서드는 interrupt()메서드가
			//                호출되면 true를 반환한다.
