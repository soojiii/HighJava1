...
/*
 * 서브릿이란? ==> 컨테이너에 의해 관리되는 자바 기반 웹 컨포넌트로서
 * 				동적인 웹 컨테느 생성을 가능하게 해  준다.
 */
...
/*
 * 요청URL : http://localhost:80/webTest/ServlrtTest01.do
 * 1) http  ==>프로토콜
...
public class ServletTest01 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html; charset=utf-8");  //응답 문서의 
		...
		out.append("<html>")
			...
			.append("<title>첫번째Servlet엽습</title>")
			.append("</head>")
			.append("<body>")
