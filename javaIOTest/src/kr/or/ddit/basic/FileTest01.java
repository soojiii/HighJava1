...
//		File file1 = new File("f:/D_Other/test.text"); //구분문자를 '/'로 사용
		File file1 = new File("f:\\d_other\\test.txt"); //구분문자를 '\'로 사용
		...
		// ==> 'parent'디렉토리 안에 있는 'child'파일을 갖는다.
		File file4 = new File("f:/D_Other", "test.txt");
		...
		File file5 = new File("f:/d_other/연습용");
		...
		File file6 = new File("f:/d_other/test/java/src");
		if(file6.mkdirs()) {
